...
class MinesweeperAI():
    ...
    # 3. Create a new sentence based on the value of cell and count
    ...
    # 4. Update self.knowledge with the new sentence
        self.knowledge.append(new_sentence)

    # 5. Check for additional cells that can be marked as safe or mines
        self.update_safes_and_mines()

    # 6. Check for new sentences that can be inferred and add them to self.knowledge
    ...
    def update_safes_and_mines(self):
        ...
        # Update self.safes and self.mines
            self.safes.update(known_safes)
            self.mines.update(known_mines)

    # Remove known safes and mines from all sentences
    ...
    def make_safe_move(self):
        ...
        """
         ...
         # Find a safe move that hasn't been made
    ...
    def make_random_move(self):
        ...
        """
         ...
         # Find a random move that hasn't been made and is not a known mine
        possible_moves = set(itertools.product(range(self.height), range(self.width))) - self.moves_made - self.mines
        if possible_moves:
